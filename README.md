...
[audit-agent-docs](audit-agent-docs) and [codehealth](codehealth) are skills I use often to keep vibe coded projects somewhat maintainable. [challenge-me](challenge-me) is a quick gut-check before committing to a direction.
