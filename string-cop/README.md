...
Up to 10 agents independently review the interface's user-facing strings, each through a different lens. After all finish, findings are deduplicated and distilled into:
